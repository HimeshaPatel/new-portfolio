export const Bio = {
  ...
  resume:
    "https://drive.google.com/file/d/1anxlHsFBWC-k6T5TY6QSR6NtHOL8WB10/view?usp=sharing",
...
export const experiences = [
  ...
  },
  {
    ...
    desc: "At Gainserv Tech LLP, a startup with a SaaS product for user onboarding, I led the development of the Gainservtech platform, setting up frontend architecture, CI/CD pipelines, and project infrastructure. I designed and developed the UI for Userlove, a no-code SaaS platform, using React.js and Material UI, enhancing onboarding experiences. I created wireframes and prototypes in Figma, collaborated with stakeholders to refine UX, and deployed applications on AWS using EC2 and Lambda with Docker for scalability.",
    skills: [
      "Docker",
      "Terraform",
      "AWS",
  ...
  },
  {
    ...
    desc: "I have extensive experience in designing and maintaining websites using front-end frameworks like Bootstrap and Foundation, ensuring efficient development. I specialize in creating landing pages and email campaigns to enhance user engagement and conversion rates. With expertise in WordPress CMS, Adobe Creative Suite (Photoshop), and UX/UI best practices, I develop responsive and SEO-optimized websites using HTML, CSS, and JavaScript.",
    skills: [
      "HTML",
      "CSS",
      "JavaScript",
  ...
  {
    id: 4,
    img: "/images/ssd-logo.png",
    role: "Web Designer",
    company: "Sunil Medico Software",
    date: "Aug 2014 - Sep 2015",
    desc: "Designed and developed early-stage web projects using ASP.NET, delivering complex web solutions that met critical business needs ahead of schedule by 10%.Collaborated with cross-departmental teams and analysts to define project scopes, resulting in more focused and efficient development cycles.",
    skills: [
      "HTML",
      "CSS",
      ".NET",
...
export const education = [
  {
    ...
    degree: "Master of Computer and Applied Sciences",
  },
  {
    id: 1,
...
export const projects = [
  ...
  },
  {
    ...
    webapp: "https://himeshapatel.github.io/",
  },
  {
    id: 0,
    title: "Parallax Scrolling Website",
    image:
      "images/parrllax-2.png",
